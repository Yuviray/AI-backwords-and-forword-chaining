...
key. */
   // printf("*** CLAUSE VARIABLE LIST ***\n");
    ...
    clvarlt[5].assign("DE");
    clvarlt[9].assign("DE");
    clvarlt[10].assign("DI");
    clvarlt[13].assign("QU");
    clvarlt[14].assign("GR");
    clvarlt[15].assign("EX");
    clvarlt[17].assign("QU");
    clvarlt[18].assign("GR");
    clvarlt[19].assign("EX");
    clvarlt[21].assign("QU");
    clvarlt[22].assign("GR");
